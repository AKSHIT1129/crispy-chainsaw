...
--------------------------------
Streams CSI data live from an ESP32 via Serial port (or simulated demo mode)
and plots subcarrier amplitude variations in real-time.

Usage:
    python python/real_time_plotter.py --port COM3 --baud 115200
    python python/real_time_plotter.py --demo
"""
